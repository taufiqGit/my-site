...
export default function Profile() {
    return(
        <figure className='flex flex-col items-center lg:flex-row bg-white p-6 rounded-lg'>
          <img className='w-64 h-64 rounded-full object-cover' src={avatar} alt="avatar" />
          <div className='ml-4 mt-8 lg:mt-0 w-full flex flex-col justify-between lg:flex-row'>
            ...
            <div className='flex flex-col lg:mt-0 mt-4'>
              <ItemContact icon={mailIcon} mt={false} info="taufiqhidayah1199@gmail.com" alt="mail"/>
              <ItemContact icon={callIcon} mt={true} info="(+62) 896 440 948 93" alt="call"/>
              <ItemContact icon={githubIcon} mt={true} info="github.com/taufiqGit" alt="github"/>
            </div>
          </div>
        </figure>   
    )
